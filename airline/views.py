    ...
    if request.method == "GET":
        ...
        for row in query:
            ...
            if add:
                ...
                entry["dep_airport"] = Airport.objects.filter(name=requestData["dep_airport"]).values()[0]
                entry["dest_airport"] = Airport.objects.filter(name=requestData["dest_airport"]).values()[0]
